...
SECRET_KEY = 'django-insecure-fw(k^r3ait8(0*@+jj(y3zg!4u873b6#f^-2*p5fzn6ng4zqpw'
...
INSTALLED_APPS = [
    ...
    # 'django_watchfiles',    #django-watchfiles (Doesn't allow "django-browser-reload with" to function as intended)
    'attendance',
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = ['attendance/public/']
